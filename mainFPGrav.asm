...
.dinoUpdate
    ...
    ;only add integer grav to dino y to slow down accel
    call ShiftFixedPointToInt ;takes bc returns b int
    ld c, b
    ld b, 0
...
.checkDinoGround
    ld a, [$D000]  ;dino y
    cp a, 104
    jr nc, .setDinoTo100  ;if dino less than or equal to 100, no need to setDinoTo100
    jp Dropper
